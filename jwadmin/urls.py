...
urlpatterns = [
    ...
    path(
        "service_occurrence/list",
        list_service_occurrences_view,
        name="list_service_occurrences",
    ),
    path(
        "service_occurrence/new",
        new_service_occurrence_view,
        name="new_service_occurrence",
    ),
    path(
        "service_occurrence/<int:id>/edit",
        edit_service_occurrence_view,
        name="edit_service_occurrence",
    ),
    path(
        "service_occurrence/<int:id>/show",
        show_service_occurrence_view,
        name="show_service_occurrence",
    ),
